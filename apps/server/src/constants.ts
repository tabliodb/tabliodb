...
export enum AuditAction {
  ...
  FolderAccessAdded = 'folder.access_added',
  FolderAccessRemoved = 'folder.access_removed',
  FolderAccessRoleUpdated = 'folder.access_role_updated',
  ...
  TeamFolderAccessRemoved = 'team.folder_access_removed',
  TeamFolderAccessUpdated = 'team.folder_access_updated',
